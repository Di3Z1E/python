...
print(
    ...
    f_name.title(),
    l_name.title(),
    "I'm glad we getting to know each other!",
)
...
if job == "yes":
    if age <= 16:
        print("You too young to have a job! \nstart over")
        exit()
    elif age >= 75:
        print("")
    ...
    print(
        "Would you like to tell me which indstury would you like to work? (High-tech/Food/Delivery/etc)"
    )
    job_indstury = input("")
...
if job == "yes":
    ...
    if years_Job >= age:
        ...
        if job_seek == "yes":
            print(
                "I would suggest you try to open a linkedin account and start from there"
            )
        else:
...
if job == "yes":
    print(
        "\nI was really happy to finally meet you",
        f_name.title(),
        l_name.title(),
        ", I also likes",
        fav_food,
        """\nI can see you have some really nice amount of expeirnce at""",
        job_indstury,
        "you stiil young! just a",
        age,
        "years old, there is so much you can do!",
    )
elif job == "no":
    print(
        "\nI was really happy to finally meet you",
    ...
    I would recommend to search on linkedin for a new opprtinuties for""",
        job_indstury,
        "and start your way up from there!" "you stiil young! just a",
        age,
        "years old, there is so much you can do!",
    )